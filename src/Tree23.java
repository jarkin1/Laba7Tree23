...
public class Tree23<T extends Comparable<T>> {
    ...
    private void preOrderI(Node current, int level) {
        ...
        if (current != null) {
            ...
            preOrderI(current.left, level+1);
            preOrderI(current.mid, level+1);
            ...
            if (current.rightElement != null) {
                ...
                preOrderI(current.right, level+1);
            }
        }
    }
...
//    }
     ...
     * (see the method "rebalance" below implemented in the private class Test) so we will not have many troubles in
    ...
    private boolean removeI(Node current, T element) {
        ...
        if (current == null) deleted = false;
            ...
            if (!current.getLeftElement().equals(element)) {
                ...
                // If there is no element in the right (2 Test) or the element to delete is less than the right element
     ...
     * <p>
     * - 2 Test : This node only has two childs, <b>always left and mid</b>. The right element is empty (null) and the
     * right node/child is also null.
     * <p>
     * - 3 Test : This node has the two elements, so it also has 3 childs: left, mid and right. It is full.
     */
    private class Node {
        private Node left;
        private Node mid;
        ...
        /**
         * Constructor of a 3 Test without the childs defined yet (null references).
         *
        ...
        /**
         * Constructor of a 3 Test with the left and mid nodes/childs defined.
         *
         * @param leftElement  the element in the left
         * @param rightElement the element in the right
        ...
        private boolean isBalanced() {
            ...
            // There are two cases: 2 Test or 3 Test
            else if (left.getLeftElement() != null && mid.getLeftElement() != null) {
                if (rightElement != null) { // 3 Test
